...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3">
      {/* Tooltip */}
      {isHovered && (
        <div className="bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-medium whitespace-nowrap animate-fade-in">
      ...
      <button
        ...
        className="group relative w-14 h-14 xs:w-16 xs:h-16 bg-[#25D366] hover:bg-[#20ba5a] rounded-full shadow-2xl hover:shadow-[#25D366]/50 transition-all duration-300 flex items-center justify-center hover:scale-110 active:scale-95"
        aria-label="Contact us on WhatsApp"
      >
        {/* WhatsApp Icon */}
        <svg
          className="w-8 h-8 xs:w-9 xs:h-9 text-white"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
